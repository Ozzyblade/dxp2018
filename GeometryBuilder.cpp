...
Mesh& BuildCube(MeshManager& mgr, int choice)
{
	...
	if (choice == 0)
	{
		VertexPosNormTex vertices[] =
		{	//front
			{ Vector3(0, 0, 0), Vector3(0, 0, -1), Vector2(0, 1) },
			{ Vector3(0, 1, 0), Vector3(0, 0, -1), Vector2(0, 0) },
			{ Vector3(1, 1, 0), Vector3(0, 0, -1), Vector2(1, 0) },
			{ Vector3(1, 0, 0), Vector3(0, 0, -1), Vector2(1, 1) },
			//right
			{ Vector3(1, 0, 0), Vector3(1, 0, 0), Vector2(0, 1) },
			{ Vector3(1, 1, 0), Vector3(1, 0, 0), Vector2(0, 0) },
			{ Vector3(1, 1, 1), Vector3(1, 0, 0), Vector2(1, 0) },
			{ Vector3(1, 0, 1), Vector3(1, 0, 0), Vector2(1, 1) },
			//left
			{ Vector3(0, 0, 1), Vector3(-1, 0, 0), Vector2(0, 1) },
			{ Vector3(0, 1, 1), Vector3(-1, 0, 0), Vector2(0, 0) },
			{ Vector3(0, 1, 0), Vector3(-1, 0, 0), Vector2(1, 0) },
			{ Vector3(0, 0, 0), Vector3(-1, 0, 0), Vector2(1, 1) },
			//top
			{ Vector3(0, 1, 0), Vector3(0, 1, 0), Vector2(0, 1) },
			{ Vector3(0, 1, 1), Vector3(0, 1, 0), Vector2(0, 0) },
			{ Vector3(1, 1, 1), Vector3(0, 1, 0), Vector2(1, 0) },
			{ Vector3(1, 1, 0), Vector3(0, 1, 0), Vector2(1, 1) },
			//bottom
			{ Vector3(1, 0, 0), Vector3(0, -1, 0), Vector2(0, 1) },
			{ Vector3(1, 0, 1), Vector3(0, -1, 0), Vector2(0, 0) },
			{ Vector3(0, 0, 1), Vector3(0, -1, 0), Vector2(1, 0) },
			{ Vector3(0, 0, 0), Vector3(0, -1, 0), Vector2(1, 1) },
			//back
			{ Vector3(1, 0, 1), Vector3(0, 0, 1), Vector2(0, 1) },
			{ Vector3(1, 1, 1), Vector3(0, 0, 1), Vector2(0, 0) },
			{ Vector3(0, 1, 1), Vector3(0, 0, 1), Vector2(1, 0) },
			{ Vector3(0, 0, 1), Vector3(0, 0, 1), Vector2(1, 1) }
		};
		...
		VertexPosNormTex vertices[] =
		{	//front
		{ Vector3(0.4, 0.4, -0.001), Vector3(0, 0, -1), Vector2(0, 1) },
		{ Vector3(0.4, 0.6, -0.001), Vector3(0, 0, -1), Vector2(0, 0) },
		{ Vector3(0.6, 0.6, -0.001), Vector3(0, 0, -1), Vector2(1, 0) },
		{ Vector3(0.6, 0.4, -0.001), Vector3(0, 0, -1), Vector2(1, 1) },
		//right
		{ Vector3(1.001, 0.4, 0.4), Vector3(1, 0, 0), Vector2(0, 1) },
		{ Vector3(1.001, 0.6, 0.4), Vector3(1, 0, 0), Vector2(0, 0) },
		{ Vector3(1.001, 0.6, 0.6), Vector3(1, 0, 0), Vector2(1, 0) },
		{ Vector3(1.001, 0.4, 0.6), Vector3(1, 0, 0), Vector2(1, 1) },
		//left
		{ Vector3(-0.001, 0.4, 0.6), Vector3(-1, 0, 0), Vector2(0, 1) },
		{ Vector3(-0.001, 0.6, 0.6), Vector3(-1, 0, 0), Vector2(0, 0) },
		{ Vector3(-0.001, 0.6, 0.4), Vector3(-1, 0, 0), Vector2(1, 0) },
		{ Vector3(-0.001, 0.4, 0.4), Vector3(-1, 0, 0), Vector2(1, 1) },
		//top
		{ Vector3(0.4, 0.6, 0.4), Vector3(0, 1, 0), Vector2(0, 1) },
		{ Vector3(0.4, 0.6, 0.6), Vector3(0, 1, 0), Vector2(0, 0) },
		{ Vector3(0.6, 0.6, 0.6), Vector3(0, 1, 0), Vector2(1, 0) },
		{ Vector3(0.6, 0.6, 0.4), Vector3(0, 1, 0), Vector2(1, 1) },
		//bottom
		{ Vector3(0.6, 0.4, 0.4), Vector3(0, -1, 0), Vector2(0, 1) },
		{ Vector3(0.6, 0.4, 0.6), Vector3(0, -1, 0), Vector2(0, 0) },
		{ Vector3(0.4, 0.4, 0.6), Vector3(0, -1, 0), Vector2(1, 0) },
		{ Vector3(0.4, 0.4, 0.4), Vector3(0, -1, 0), Vector2(1, 1) },
		//back
		{ Vector3(0.6, 0.4, 1.001), Vector3(0, 0, 1), Vector2(0, 1) },
		{ Vector3(0.6, 0.6, 1.001), Vector3(0, 0, 1), Vector2(0, 0) },
		{ Vector3(0.4, 0.6, 1.001), Vector3(0, 0, 1), Vector2(1, 0) },
		{ Vector3(0.4, 0.4, 1.001), Vector3(0, 0, 1), Vector2(1, 1) }
		};
		...
		Mesh &mesh = mgr.CreateMesh("window");
		MaterialExt mat = MaterialExt::default;
		mesh.CreateFrom(vertices, 24, indices, 36, mat, 36);
		return mesh;
	}
